...
app = marimo.App(
    width="medium",
    app_title="Réacteur parfaitement agité transitoire",
)


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""# Modélisation d'un réacteur parfaitement agité en régime transitoire""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Partie I - Enoncé""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Partie II - Modélisation""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(rf"""La résolution du système différentiel conduit aux courbes suivantes :""")
    return


@app.cell(hide_code=True)
def _(CAe_slider, CBe_slider, k1_slider, k2_slider, mo, tau_slider):
    import numpy as np
